...
window.addEventListener("load", ers_map_info, false);

function ers_map_info() {
    /* Den ID-Selector nutzen um auf das <div> Element
       mit der id=ers_info_button_id Bezug zu nehmen.
    */
    var ers_info_button_id = document.getElementById("ers_info_button_id");

    /* Mit der d Taste die Methode 'show_ers_details()' zum
       anzeigen von Karten-Details aufrufen.
    */
    document.addEventListener("keypress", function(e) {
        if (e.key === 'd') {
            show_ers_details(ers_info_button_id);
        }
    }, false);
}

function show_ers_details() {
